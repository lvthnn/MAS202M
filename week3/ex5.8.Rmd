...
$$
X \sim \mathcal N(\mathbf{0}, \mathbf I_{100}) \quad \text{and} \quad Y \sim \mathcal N(X - 2X^2, \sigma^2 \mathbf{I}_{100}).
$$
...
Upon including the quadratic term most of the variance in the data. In fact, the cubic and quartic terms fail to reach statistical significance. This is evident when displaying the models visually against the data.
